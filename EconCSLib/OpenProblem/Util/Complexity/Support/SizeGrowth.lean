...
/-!
# Support library for polynomial size growth
...
This module supplies constructors and theorems for the definitions in
`Complexity.Definitions.SizeGrowth`.  It follows the useful
...
coefficient/exponent normal form used by the core predicate.  The latter
